...
export default function AuthButtons() {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      {/* Xabarlar (Inbox) tugmasi - faqat desktopda */}
      <Link
        href="/inbox"
        id="nav-inbox-btn"
        aria-label="Xabarlar"
        className="hidden md:flex group relative h-9 w-9 items-center justify-center rounded-lg border border-zinc-200 bg-zinc-50 text-zinc-600 transition-all duration-150 hover:border-indigo-300 hover:bg-indigo-50 hover:text-indigo-600 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-400 dark:hover:border-indigo-600 dark:hover:bg-indigo-900/30 dark:hover:text-indigo-400"
      >
